# new terminal
# cd spider/downloads
# python .\mongo_import.py -c tracks -i ../file.jl -u 'mongodb+srv://mongodb:N0t+-s3t2000@mongodbhike.mongocluster.cosmos.azure.com/?tls=true&authMechanism=SCRAM-SHA-256&retrywrites=false&maxIdleTimeMS=120000'
